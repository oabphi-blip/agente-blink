...
# ---------------------------------------------------------------------------
# Campo "A FAZER" — multiselect, campo humano + bot (field_id 1259312)
# Origem: campo manual da equipe, referenciado no _MASTER_INSTRUCTION.md.
# C-114 (11/08/2026): adicionado enum "Fila Encaixe" (enum_id 927866)
# para registrar quando paciente PARTICULAR escolhe fila de encaixe após
# conclusão de agendamento (poltrona de avião).
# ---------------------------------------------------------------------------
FIELD_A_FAZER = (1259312, {
    "encaixe":               927023,
    "ligacao":               927264,
    "prefere_fazer_contato": 927790,
    "pos_consulta":          925064,
    "fila_encaixe":          927866,   # C-114 — paciente escolheu fila sem pagamento
    "nao_se_aplica":         924820,
})
