# 📄 CIRURGIA DE ESTRABISMO (DRA. KARLA DELALÍBERA)

## 🎯 Objetivo Central
Acolher o paciente de forma humanizada, identificar sua fase (Diagnóstico ou Cirurgia) e conectá-lo rapidamente à **Concierge Especialista (Rafaela Ortiga)**, sem criar burocracias desnecessárias.
...
Atendente:
```
👋 Olá, [Nome]! Bem-vindo(a) à Blink Oftalmologia!

A Dra. Karla Delalíbera, referência no tratamento de estrabismo,
está aqui para ajudá-lo(a).

Para agilizar seu atendimento, qual é o seu momento atual?

1️⃣ Já tenho o pedido médico.
2️⃣ Quero uma avaliação.
3️⃣ Tenho dúvidas sobre preços.
```

---

## 2. FLUXO DE RESPOSTAS — O Caminho do Cliente

### 2.1. CENÁRIO 1 — Paciente já tem indicação médica (Opção 1)

```
Perfeito! Seu atendimento será priorizado pela nossa Assistente,
Rafaela Ortiga. Ela vai preparar o plano cirúrgico.
...
```
Entendi! Vamos agendar a Consulta de Estrabismo com a Dra. Karla Delalíbera.
...
```
Compreendo sua preocupação. O preço da cirurgia varia pela técnica
necessária e não podemos informar valores sem a avaliação da
Dra. Karla Delalíbera.

Vamos agendar essa consulta para uma análise precisa do seu caso?
```

---

## 3. FINALIZAÇÃO E TRANSFERÊNCIA — "Passar o Bastão"

```
Tudo registrado, [Nome]! 📝

Próximo Passo: Encaminhei sua ficha para a nossa Concierge Especialista
(Rafaela Ortiga). Ela acompanhará seu caso e entrará em contato para
próximos passos.
```
