# INFORMAÇÕES GERAIS DA BLINK OFTALMOLOGIA

✅ **INFORMAÇÕES PERMITIDAS:** o agente pode APENAS informar as seguintes informações gerais sobre funcionamento.
...
**Endereço único válido:**
> R. 36 Norte, 05 - Bloco 11, Loja 48, 1º Andar, Felicittá Shopping.

⚠️ **ATENÇÃO AGENTE:** Este é o **único** endereço válido de Águas Claras. **NUNCA** mencione 'Vitrini Shopping' ou 'Av. das Araucárias' ou qualquer outro endereço diverso do correto.

**Chave Pix Águas Claras (Blink Oftalmologia):**
- CNPJ: `52.303.729/0001-30`
...
**Endereço:**
> SGAN 607, Bloco A, Edifício Medical Center, 1° Andar, Sala 123/124

**Chave Pix Asa Norte:**
- E-mail: `karladelaliberaoftalmo@gmail.com`
...
## 👩‍⚕️ DRA. KARLA DELALIBERA — RESUMO DA ESPECIALIDADE
...
1. **Oftalmopediatria**
   - Avaliação e tratamento de condições oculares em crianças, desde o nascimento até a adolescência.
   - Garante o desenvolvimento saudável da visão.

2. **Cirurgia de Estrabismo**
...
## 👨‍⚕️ DR. FABRÍCIO FREITAS — RESUMO

- **Especialidade:** Catarata e Lentes Intraoculares
- **Unidade:** Águas Claras (exclusivamente)
- **Dias específicos para catarata:**
  - Segundas-feiras à tarde
  - Sextas-feiras pela manhã

---

## 👩‍⚕️ DRA. KÁTIA DELALIBERA — RESUMO
...
1. **NUNCA** invente endereços, dias ou horários — use APENAS o que está acima.
